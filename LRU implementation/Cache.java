...
public interface Cache<K, V> {
	 ...
	 * This method calls the LookUp method found in LinearHashTable class.
	...
	/**
	 * Stores data associated with the given key. If required, it evicts a
	 * data record to make room for the new one
	 * This method calls the Store method found in LinearHashTable class.
